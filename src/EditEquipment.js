...
function EditequipmentForm({equipment})
{
  ...
  const [rent_per_month, setrent_per_month] = useState(equipment.rent_per_month);
...
<TextField value={img} label="img" variant="outlined" onChange={(event) => setimg(event.target.value)} />
